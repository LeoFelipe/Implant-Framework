...
class SetoresDAO extends DAO
{
    private $entidade = '\Implant\Core\Model\Setores';
    ...
    public function cadastrar(\Implant\Core\Model\Setores $setor)
    {
        DAO::$entityManager->getConnection()->beginTransaction();
        try
        {
            DAO::$entityManager->persist($setor);
    ...
    public function editar(\Implant\Core\Model\Setores $setor)
    {
        DAO::$entityManager->getConnection()->beginTransaction();
        try
        {
    ...
    public function excluir(\Implant\Core\Model\Setores $setor)
    {
        DAO::$entityManager->getConnection()->beginTransaction();
        try
        {
            DAO::$entityManager->remove($setor);
            DAO::$entityManager->flush();
            DAO::$entityManager->getConnection()->commit();
            return true;
        }
