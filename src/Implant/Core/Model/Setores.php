...
class Setores extends Model
{
     ...
     * @Column(type="integer", name="seto_id")
     */
    private $id;
    
    /**
     * @Column(type="string", name="seto_nome")
     */
    private $nome;
    
    /**
     * @Column(type="integer", name="seto_status")
     */
    private $status;
    
    /**
     * @Column(type="string", name="seto_dtInsert")
     */
    private $dtInsert;
    
    /**
     * @Column(type="string", name="seto_dtEdit")
     */
    private $dtEdit;
    ...
    {
        if (empty($this->nome) || !is_string($this->nome) || strlen($this->nome) < 2)
            return false;
