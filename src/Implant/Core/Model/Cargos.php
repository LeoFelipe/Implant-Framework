...
class Cargos extends Model
{
     ...
     * @Column(type="integer", name="carg_id")
     */
    private $id;
    
    /**
     * @Column(type="string", name="carg_nome")
     */
    private $nome;
    
    /**
     * @Column(type="integer", name="carg_status")
     */
    private $status;
    
    /**
     * @Column(type="string", name="carg_dtInsert")
     */
    private $dtInsert;
    
    /**
     * @Column(type="string", name="carg_dtEdit")
     */
    private $dtEdit;
